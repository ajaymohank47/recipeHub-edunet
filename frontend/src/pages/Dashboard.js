...
const Dashboard = () => {
  ...
  const fetchUserRecipes = async () => {
    try {
      ...
      const response = await fetch("https://recipehub-backend-cx3k.onrender.com/api/recipes/user/recipes", {
        headers: {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(`https://recipehub-backend-cx3k.onrender.com/api/recipes/${id}`, {
        method: "DELETE",
        headers: {
