...
function RecipeDetails() {
  ...
  useEffect(() => {
    fetch(`https://recipehub-backend-cx3k.onrender.com/api/recipes/${id}`)
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.watchVideo}>
        <p>Watch this Recipe Video on YouTube</p>
...
// Styles with transitions for seamless card behavior
const styles = {
  container: {
    display: "flex",
  ...
  recipeBox: {
    ...
    textAlign: "center",
    marginBottom: "20px", // Reduced margin to make it closer
    width: "100%",
  ...
  image: {
    ...
    height: "auto",
    borderRadius: "15px",
    boxShadow: "0px 6px 15px rgb(255, 123, 0)",
    marginBottom: "15px",
  },
  title: {
    fontSize: "36px",
    fontWeight: "700",
    color: "#ff7500", // Changed to #ff7500
    marginBottom: "20px",
  },
  description: {
    fontSize: "18px",
