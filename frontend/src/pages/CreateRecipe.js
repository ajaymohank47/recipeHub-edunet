  ...
  return (
    <div className="container d-flex justify-content-center align-items-center min-vh-100 ">
      <div className="col-md-8 col-lg-6 p-4 shadow rounded bg-white">
        <h2 className="text-center mb-4 fw-bold text-black"> Create Recipe 🍽️</h2>
        <form onSubmit={handleSubmit}>
          ...
          <button type="button" onClick={() => addArrayItem("steps")} className="btn btn-success mb-3">+ Add Step</button>
