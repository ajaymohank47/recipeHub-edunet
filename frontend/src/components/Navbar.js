    ...
    <div>
      <nav style={styles.topNavbar}>
        <h1 style={styles.logo} onClick={() => navigate("/")}>
          FoodHub <span style={styles.icon}></span>
        </h1>
...
const styles = {
  topNavbar: {
    ...
    background: "linear-gradient(to right,rgb(255, 255, 255),rgb(255, 255, 255))",  // Updated color
  ...
  navBtn: {
    ...
    padding: "10px 18px",
    fontSize: "16px",
    border: "1px solid #ff7500", // Updated color
    borderRadius: "20px",
    cursor: "pointer",
    fontWeight: "bold",
  ...
  navBtnHover: {
    transform: "scale(1.1)",
    backgroundColor: "#ff7500",  // Updated color
    color: "#fff",
  },
  logoutBtn: {
    background: "#ff7500",  // Updated color
    color: "#fff",
    borderColor: "#ff7500",  // Updated color
    fontWeight: "bold",
    transition: "all 0.3s ease-in-out",
